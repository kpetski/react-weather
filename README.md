# Final Exam Project
Create a weather widget.  Code has been deployed to https://kpetski.github.io/react-weather
- Display city name
- Display forecast
- Use JSX
- Use multiple modularized (different files) components
- Create an input field for the city name for which you can to get the forecast
